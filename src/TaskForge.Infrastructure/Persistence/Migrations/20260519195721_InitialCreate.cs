        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskItems_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_OwnerUserId_DueDate",
                table: "TaskItems",
                columns: new[] { "OwnerUserId", "DueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_OwnerUserId_Priority",
                table: "TaskItems",
                columns: new[] { "OwnerUserId", "Priority" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_OwnerUserId_Status",
                table: "TaskItems",
